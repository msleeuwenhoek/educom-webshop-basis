...
<?php if (!$valid) : ?>
  <div class="content">
    ...
    <form class="contact-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      ...
      <input class="form-field" type="text" id="phonenumber" name="phonenumber" value="<?php echo $phonenumber; ?>" />
      <span class="error">* <?php echo $phonenumberErr; ?></span>

      <br />
      <span>Preferred communication channel:</span>
      <input type="radio" id="email_channel" name="communication_channel" value="email" <?php if (isset($communication_channel) && $communication_channel == "email") echo "checked"; ?> />
      <label for="email_channel">Email</label>
      <input type="radio" id="phone_channel" name="communication_channel" value="phone" <?php if (isset($communication_channel) && $communication_channel == "phone") echo "checked"; ?> />
